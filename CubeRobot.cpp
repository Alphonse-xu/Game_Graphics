...
CubeRobot::CubeRobot(void) {
	...
	body->SetBoundingRadius(30.0f);
	head->SetBoundingRadius(10.0f);

	leftArm->SetBoundingRadius(36.0f);
	rightArm->SetBoundingRadius(36.0f);

	leftLeg->SetBoundingRadius(36.0f);
	rightLeg->SetBoundingRadius(36.0f);
}
